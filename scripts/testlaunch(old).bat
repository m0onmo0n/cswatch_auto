...
:: --- Start the main Python application (web server and worker) ---
echo [3/4] Starting the main Python application...
start "d2v single" cmd /K "cd d2v_single &% python main.py"
